...
"use strict";
/*!*********************************************!*\
  !*** ./resources/assets/scripts/welcome.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
...
vue__WEBPACK_IMPORTED_MODULE_5__.default.use((vue_scrollto__WEBPACK_IMPORTED_MODULE_1___default()));
vue__WEBPACK_IMPORTED_MODULE_5__.default.use((vue_loading_overlay__WEBPACK_IMPORTED_MODULE_2___default()));
(axios__WEBPACK_IMPORTED_MODULE_0___default().defaults.headers["X-CSRF-TOKEN"]) = $('meta[name="csrf-token"]').attr('content');
/*
...
new vue__WEBPACK_IMPORTED_MODULE_5__.default({
  ...
  watch: {
    place_index: function place_index(val) {
  ...
  methods: {
    getAuthUser: function getAuthUser() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/auth/getUser').then(function (_ref) {
        var data = _ref.data;
    ...
    updateTime: function updateTime() {
      ...
      this.current_time = luxon__WEBPACK_IMPORTED_MODULE_6__.DateTime.now().toFormat('hh:mm:ss a');
      setTimeout(function () {
    ...
    validateLoginForm: function validateLoginForm() {
      ...
      if (!/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/.test(this.email)) this.loginFormErrors.email = 'Por favor ingresa un email valido';
      if (!/^(\w+\S+)$/.test(this.password)) this.loginFormErrors.password = 'Por favor ingresa una contraseña';
    ...
    signIn: function signIn() {
      ...
      if (this.validateLoginForm()) {
        axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/auth/login', {
          ...
          _this4.closeLoginModal();

          _this4.getAuthUser();

          loader.hide();
        })["catch"](function (error) {
          _this4.notifyLoginError('Error, email o contraseña incorrecta');

          loader.hide();
        });
      }
    },
    notifyLoginError: function notifyLoginError(msg) {
      this.$notify({
        group: 'foo',
        type: 'error',
        text: msg
    ...
    logout: function logout() {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/auth/logout').then(function (result) {
        return window.location.href = '/';
      })["catch"](function (error) {
        return alert('Error, intente de nuevo');
      });
    }
  }
});
